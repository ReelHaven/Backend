...
public record CreateContentResource(String creatorId, String type, String title, String description,String category,String objective,String feeling, String image) {
    public CreateContentResource {
